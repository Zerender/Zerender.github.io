...
const Contact = ({ offset, factor = 1 }: { offset: number; factor?: number }) => (
  <div>
    ...
    <Divider speed={0.1} offset={offset} factor={factor}>
      <UpDown>
        <SVG icon="hexa" stroke width={8} color="icon_darkest" left="70%" top="20%" />
        <SVG icon="triangle" width={8} stroke color="icon_darkest" left="25%" top="5%" />
      </UpDown>
      <UpDownWide>
        <SVG icon="triangle" width={12} stroke color="icon_darkest" left="95%" top="50%" />
        <SVG icon="circle" hiddenMobile width={6} color="icon_darkest" left="85%" top="15%" />
        <SVG icon="hexa" stroke width={8} color="icon_darkest" left="45%" top="10%" />
      </UpDownWide>
