  ...
  <div>
    ...
    <Divider speed={0.1} offset={offset} factor={factor}>
      <UpDown>
        ...
        <SVG icon="hexa" stroke width={8} color="icon_teal" left="70%" top="20%" />
      </UpDown>
      <UpDownWide>
        <SVG icon="hexa" stroke hiddenMobile width={16} color="icon_green" left="20%" top="90%" />
        ...
        <SVG icon="circle" hiddenMobile width={6} color="icon_brightest" left="75%" top="10%" />
        <SVG icon="hexa" stroke hiddenMobile width={8} color="icon_green" left="45%" top="10%" />
      </UpDownWide>
      <SVG icon="circle" hiddenMobile width={6} color="icon_brightest" left="4%" top="20%" />
      <SVG icon="circle" width={12} color="icon_purple" left="80%" top="60%" />
